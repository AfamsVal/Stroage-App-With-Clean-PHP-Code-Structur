                    ...
                    <div>
                        <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                            ...
                            <form method='POST' action='/note'>
                                ...
                                <div class="mb-6">
                                    <textarea name='body' rows='5' placeholder='Description...' class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"><?= $note['body'] ?? '' ?></textarea>
