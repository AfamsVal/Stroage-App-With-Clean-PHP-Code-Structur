            ...
            <div class="hidden md:block">
              ...
              -->
                ...
                <?php else : ?>
                    ...
                    <a href="/register" class='flex max-w-md w-full my-2 bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 focus:outline-none text-white text-lg shadow-md rounded-full mx-auto py-1 px-8'>
                        <div class="flex sm:flex-cols-12 gap-1">
                            ...
                            <div class="col-span-2 pt-2">Register</div>
                        </div>
                    </a>
                <?php endif; ?>
            </div>
